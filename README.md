...
## Стандарт Allure анотацій

Для всіх нових і оновлених тестів/сторінок обов'язково використовувати:

- `@allure.feature("...")` для кожного тесту
- `@allure.story("...")` для кожного тесту
- `@allure.step("...")` для дій у методах Page Object / Component Object
